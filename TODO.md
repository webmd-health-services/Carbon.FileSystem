...
* Rename every file that has `Carbon.FileSystem` in its name, replacing `Carbon.FileSystem` with the module name.
* Replaces `Carbon.FileSystem` in every file with the module name.
