...
@{
    ...
    Description = 'Functions for managing and making it easier to work with the Windows file system, files, and directories.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/webmd-health-services/Carbon.FileSystem'
